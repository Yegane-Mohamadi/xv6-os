...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4ed4:	00003797          	auipc	a5,0x3
    4ed8:	57c7b783          	ld	a5,1404(a5) # 8450 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    4f6c:	4e853503          	ld	a0,1256(a0) # 8450 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    4f98:	00003917          	auipc	s2,0x3
    4f9c:	4b890913          	addi	s2,s2,1208 # 8450 <freep>
  if(p == (char*)-1)
    4fa0:	5afd                	li	s5,-1
    ...
    base.s.ptr = freep = prevp = &base;
    4fac:	0000a797          	auipc	a5,0xa
    4fb0:	ccc78793          	addi	a5,a5,-820 # ec78 <base>
    4fb4:	00003717          	auipc	a4,0x3
    4fb8:	48f73e23          	sd	a5,1180(a4) # 8450 <freep>
  ...
  if(p == (char*)-1)
    ...
    501e:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5022:	00003717          	auipc	a4,0x3
    5026:	42a73723          	sd	a0,1070(a4) # 8450 <freep>
      return (void*)(p + 1);
