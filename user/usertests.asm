...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4ee4:	00003797          	auipc	a5,0x3
    4ee8:	56c7b783          	ld	a5,1388(a5) # 8450 <freep>
    ...
    4f10:	00e6ea63          	bltu	a3,a4,4f24 <free+0x4a>
{
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    4f4e:	00003717          	auipc	a4,0x3
    4f52:	50f73123          	sd	a5,1282(a4) # 8450 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    4f7c:	4d853503          	ld	a0,1240(a0) # 8450 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    4fa8:	00003917          	auipc	s2,0x3
    4fac:	4a890913          	addi	s2,s2,1192 # 8450 <freep>
  if(p == (char*)-1)
    4fb0:	5afd                	li	s5,-1
    ...
    4fc0:	cbc78793          	addi	a5,a5,-836 # ec78 <base>
    4fc4:	00003717          	auipc	a4,0x3
    4fc8:	48f73623          	sd	a5,1164(a4) # 8450 <freep>
  ...
  if(p == (char*)-1)
    ...
    502e:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5032:	00003717          	auipc	a4,0x3
    5036:	40a73f23          	sd	a0,1054(a4) # 8450 <freep>
      return (void*)(p + 1);
